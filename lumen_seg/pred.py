...
def prepareInputImg(base_model, whole_pred_model, tifimg, save_path=None):
    ...
    if tifimg.shape[0] != tifimg.shape[1]:
        ...
        tif_norm_img[max_axis // 2 - tifimg.shape[0] // 2:max_axis // 2 - tifimg.shape[0] // 2 + tifimg.shape[0],
                     max_axis // 2 - tifimg.shape[1] // 2:max_axis // 2 - tifimg.shape[1] // 2 +
                     tifimg.shape[1]] = tifimg
    else:
